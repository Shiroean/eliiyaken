(function() {
	...
	function() {
		var together = new Date();  //Displaydate
		together.setFullYear(lover.info.year, (lover.info.month - 1), (lover.info.day));
		together.setHours(lover.info.hour); //Hours
		together.setMinutes(lover.info.minute); //Minutes
		together.setSeconds(lover.info.second); //Seconds
